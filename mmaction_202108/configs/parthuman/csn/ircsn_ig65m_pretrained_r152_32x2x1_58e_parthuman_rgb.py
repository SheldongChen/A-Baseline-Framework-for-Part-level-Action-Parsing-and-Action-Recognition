...
val_pipeline = [
    dict(type='DecordInit'),
    dict(type='SampleFrames', clip_len=32, frame_interval=8, num_clips=1,test_mode=True),
    dict(type='DecordDecode'),
    dict(type='Resize', scale=(-1, 256)),
...
test_pipeline = [
    dict(type='DecordInit'),
    dict(type='SampleFrames', clip_len=32, frame_interval=8, num_clips=10,test_mode=True),
    dict(type='DecordDecode'),
    dict(type='Resize', scale=(-1, 256)),
...
# optimizer
optimizer = dict(
    type='SGD', lr=0.000062, momentum=0.9,
...
work_dir = './work_dirs/ircsn_ig65m_pretrained_r152_32x2x1_58e_parthuman_rgb'
