...
mmdet_root = '/export/home/cxd/202107/mmdet-202108'
mmpose_root = '/export/home/cxd/202107/mmpose_202108'
...
args.det_config = '/export/home/cxd/202107/mmdet-202108/work_dirs/yolof_r101_c5_4x6_2x_coco/yolof_r101_c5_8x8_1x_coco.py'
args.det_checkpoint = '/export/home/cxd/202107/mmdet-202108/work_dirs/yolof_r101_c5_4x6_2x_coco/epoch_17.pth'
...
#args.pose_config = '/export/home/cxd/202107/mmpose_202108/configs/body/2d_kpt_sview_rgb_img/topdown_heatmap/mpii/hrnet_w48_mpii_256x256.py'
#args.pose_checkpoint =  '/export/home/cxd/202107/mmpose_202108/work_dirs/hrnet_w48_mpii_256x256/epoch_110.pth'
...
def pose_inference(args, frame_paths, det_results):
    ...
    for i, (f, d) in enumerate(zip(frame_paths, det_results)):
        ...
        #print(d)
        #from ipdb import set_trace; set_trace()
        d = [dict(bbox=x) for x in d.tolist() if x[-1] > 0.5]
...
def ntu_pose_extraction(vid):
    ...
    img_w,img_h = imagesize.get(frame_paths[0])
    
    anno = dict()
    anno['keypoint'] = pose_results[..., :2]
    anno['keypoint_score'] = pose_results[..., 2]
    anno['frame_dir'] = osp.splitext(osp.basename(vid))[0]
    anno['img_shape'] = (img_h, img_w)
    anno['original_shape'] = (img_h, img_w)
    anno['total_frames'] = pose_results.shape[1]
    anno['label'] = 0 #int(osp.basename(vid).split('A')[1][:3])
...
if __name__ == '__main__':
    ...
    anno['label'] = int(global_args.label)
